			...
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<div class="header__logo">
						<a href="http://localhost:8080/Tuandhpc05076_SOF3011_ASM/views/index.jsp"><img src="http://localhost:8080/Tuandhpc05076_SOF3011_ASM/views/img/logoVideo1.svg" alt=""
							style="width: 300px;"></a>
					</div>
				</div>
				<div class="col-lg-9 col-md-9">
					<div class="header__nav">
						<nav class="header__menu mobile-menu">
							<ul>
								<li><a href="http://localhost:8080/Tuandhpc05076_SOF3011_ASM/views/index.jsp">Trang chủ</a></li>
								<li><a href=http://localhost:8080/Tuandhpc05076_SOF3011_ASM/views/insertVideo.jsp">Quản lý video</a></li>
								...
								<li class="active"><a href="http://localhost:8080/Tuandhpc05076_SOF3011_ASM/views/user.jsp">Quản lý nhân viên</a></li>
	...
	<div class="container" style="margin-top: 150px;">
		<div class="card card-primary">
			<div class="card-header d-flex justify-content-between">
				Danh sách nhân viên <a class="btn btn-primary" href="http://localhost:8080/Tuandhpc05076_SOF3011_ASM/views/user.jsp">
					Thêm mới </a>
			</div>
